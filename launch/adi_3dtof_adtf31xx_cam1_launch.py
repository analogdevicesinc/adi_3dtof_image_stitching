...
def generate_launch_description():
    ...
    arg_in_file_name_desc = DeclareLaunchArgument('arg_in_file_name', default_value=get_package_share_directory('adi_3dtof_adtf31xx')+ "/../../../../src/adi_3dtof_input_video_files/adi_3dtof_height_170mm_yaw_135degrees_cam1.bin")
